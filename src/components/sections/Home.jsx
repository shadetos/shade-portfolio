        ...
        <RevealOnScroll>
            <div className=" text-center z-10 and px4">
                ...
                <div className="flex justify-center">
                        <img src={RSEmojiCopy} className="w-[200px] h-[200px] rounded-full" />
                    </div>
                ...
                <div className="flex justify-center space-x-4">
                    <a href="#portfolio" className="bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] " > View Portfolio </a>
